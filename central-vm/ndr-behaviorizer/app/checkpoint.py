...
class Checkpoint:
    ...
    def from_doc(cls, source: dict[str, Any] | None) -> "Checkpoint":
        ...
        return cls(
            ...
            behaviors_written=int(source.get("behaviors_written", 0) or 0),
            findings_written=int(source.get("findings_written", 0) or 0),
    ...
    def to_doc(self) -> dict[str, Any]:
        return {
            ...
            "behaviors_written": self.behaviors_written,
...
class CheckpointStore:
            ...
            body={
                ...
                "mappings": {
                    ...
                    "properties": {
                        ...
                        "behaviors_written": {"type": "long"},
                        "findings_written": {"type": "long"},
                        "failures": {"type": "long"},
    ...
    def save(self, checkpoint: Checkpoint) -> None:
        ...
        self.client.index(index=self.settings.state_index, id=self.settings.checkpoint_id, body=checkpoint.to_doc(), refresh=False)
